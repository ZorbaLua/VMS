...
cujo índice é indicado pelo program counter, de seguida executa a função que corresponde ao codigo da instrução,
por sua vez esta função manipula as varias componetes da maquina.
...
\quad O comportamento das funções que dão uma semantica as instruções pode ser consultado, na tabela abaixo:
.
.
.
